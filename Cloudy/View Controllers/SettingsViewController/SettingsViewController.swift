...
extension SettingsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .time:
            ...
            viewModel = SettingViewTimeViewModel(timeNotation: timenotation)
        ...
        case .units:
            ...
            viewModel = SettingViewUnitsViewModel(unitsNotation: unitsNotation)
            
        case .temperature:
            guard let temperatureNotation = TemperatureNotation(rawValue: indexPath.row) else{
                fatalError("unexpected index path")
            }
            viewModel = SettingViewTempratureViewModel(temperatureNotation: temperatureNotation)
            
        }
        
        if let viewModel = viewModel {
            cell.configuer(withViewModel: viewModel)
        }
